...
public class LoginActivity extends AppCompatActivity {
    ...
    private EditText getEmployeeIdEditText() {
        return (EditText) this.findViewById(R.id.text_edit_employee_id);
    }

    private EditText getPasswordEditText() {
        return (EditText) this.findViewById(R.id.text_edit_password);
    }
    ...
    private class SignInTask extends AsyncTask<EmployeeLogin, Void, Employee> {
        ...
        protected void onPreExecute() {
            this.signInAlert = new AlertDialog.Builder(LoginActivity.this).
